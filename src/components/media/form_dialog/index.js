...
import ImagePickerAndShow from '../../doar/ImagePickerAndShow';
import SuccessForDialog from '../../shared/SuccessForDialog';
...
function FormDialog({id_evento, open, onClose,onSucess, title, apiUrl }) {
    const fields = {
        descricao: { type: 'text', label: 'Descricao', name: 'descricao', placeholder: 'Escreva a descrição da foto' },
    }
